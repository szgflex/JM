 ...
 */
public class Folder extends RelativeLayout implements DragSource, View.OnClickListener,
        View.OnLongClickListener, DropTarget, FolderListener, TextView.OnEditorActionListener,
        View.OnFocusChangeListener {
    private static final String TAG = "Launcher.Folder";

	public static int FOLDER_SCROLL_MAX_COUNT_Y;
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        mMaxCountX = grid.folderMaxColumns;
        mMaxCountY = grid.folderRows;
        mMaxNumItems = mMaxCountX * mMaxCountY;
        
        FOLDER_SCROLL_MAX_COUNT_Y = grid.folderFixColumns;
    ...
    protected void onFinishInflate() {
        ...
        mDragLayer = (DragLayer) mLauncher.findViewById(R.id.drag_layer);
        
        mScrollView = (FolderScrollView) findViewById(R.id.scroll_view);
		...
		mLine = findViewById(R.id.folder_line);
		mTopContainer = findViewById(R.id.folder_top_cantainer);
...
//        }
    ...
    private void positionAndSizeAsIcon() {
        ...
        calculateAnimatorValue();
        
		mScrollView.setScaleX(mScaleX);
		mScrollView.setScaleY(mScaleY);
		mScrollView.setTranslationX(mTranslationX);
		mScrollView.setTranslationY(mTranslationY);
		
        mState = STATE_SMALL;
    }

    public void animateOpen() {
		if (mIsAnimatoring) return;
        if (!(getParent() instanceof DragLayer)) return;
        ...
        PropertyValuesHolder translationX = PropertyValuesHolder.ofFloat("translationX", 0.0f);
        PropertyValuesHolder translationY = PropertyValuesHolder.ofFloat("translationY", 0.0f);
        final ObjectAnimator oa =
            LauncherAnimUtils.ofPropertyValuesHolder(mScrollView, scaleX, scaleY, translationX, translationY);
        ...
        oa.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
				...
				setBackgroundResource(R.color.folder_open_bgcolor);
				mLauncher.onFolderOpenBegin(Folder.this);
    ...
    public void animateClosed() {
        ...
        PropertyValuesHolder scaleX = PropertyValuesHolder.ofFloat("scaleX", mScaleX);
        PropertyValuesHolder scaleY = PropertyValuesHolder.ofFloat("scaleY", mScaleY);
        PropertyValuesHolder translationX = PropertyValuesHolder.ofFloat("translationX", mTranslationX);
        PropertyValuesHolder translationY = PropertyValuesHolder.ofFloat("translationY", mTranslationY);
        final ObjectAnimator oa =
                LauncherAnimUtils.ofPropertyValuesHolder(mScrollView, scaleX, scaleY, translationX, translationY);
    ...
    public void onDragOver(DragObject d) {
		...
		r[0] -= mScrollView.getLeft();
		r[1] -= mScrollView.getTop();
    ...
    private void setupContentDimensions(int count) {
        ...
        mContent.setGridSize(mMaxCountY, countY);
    ...
    private void centerAboutIcon() {
		...
		lp.width = mDragLayer.getWidth();
		lp.height = mDragLayer.getHeight();
		lp.x = 0;
		lp.y = 0;
    }
    ...
    private void onCloseComplete() {
        mLauncher.onFolderColseEnd(this);
        setBackground(null);
     ...
     * 计算Animator动画的值
     */
	private void calculateAnimatorValue() {
        if (!(getParent() instanceof DragLayer)) return;
        
		Rect mTempRect = new Rect();
		mDragLayer.getDescendantRectRelativeToSelf(mFolderIcon, mTempRect);
		
		mScaleX = 0.1f;
		mScaleY = 0.1f;
		
		float contentWidth = mScrollView.getDesiredWidth();
		float contentHeight = mScrollView.getDesiredHeight();
		
		float paddingLeft = (mDragLayer.getRight() - contentWidth) / 2;
		float paddintTop = mTopContainerHeight;
		
		mTranslationX = mTempRect.centerX() - contentWidth / 2 - paddingLeft;
		mTranslationY = mTempRect.centerY() - contentHeight / 2 - paddintTop;
	}
	
    /**
     * 计算分隔线左右边距(与文件夹内容Layout  Width一致)
     * 计算标题顶端间距(与文件夹内容Layout  left一致)
     */
    private void calculateLayoutValue() {
		if (mTopContainerHeight <= 0) {
			int leftAndRightPadding = (mDragLayer.getWidth() - mScrollView.getDesiredWidth()) / 2;
			
			RelativeLayout.LayoutParams lineLP = (RelativeLayout.LayoutParams) mLine.getLayoutParams();
			lineLP.setMargins(
					leftAndRightPadding,
					lineLP.topMargin,
					leftAndRightPadding,
			...
			RelativeLayout.LayoutParams topContainerLP = (RelativeLayout.LayoutParams) mTopContainer.getLayoutParams();
			topContainerLP.topMargin = leftAndRightPadding;
			
			int measureSpec = MeasureSpec.UNSPECIFIED;
			mTopContainer.measure(measureSpec, measureSpec);
			mTopContainerHeight = mTopContainer.getMeasuredHeight()
					+ mTopContainer.getPaddingTop()
					+ mTopContainer.getPaddingBottom();
			
			mTopContainerHeight += topContainerLP.topMargin;
		}
    }
}
