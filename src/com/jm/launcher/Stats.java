...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.jm.launcher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.jm.launcher.permission.RECEIVE_LAUNCH_BROADCASTS";
